...
export default function TableauMap() {
  ...
  useEffect(() => {
    const loadTableau = () => {
      ...
      vizElement.style.height = "85vh" // Aumentamos la altura para ver todo el contenido
  ...
  return (
    <div className="relative w-full">
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center min-h-[85vh]">
          {" "}
